...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/png.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/cas.login.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/capsLock.js"></script>
</head>
<body>
	<!-- header -->
	<div class="header">
				...
				<div class="logincon">
					...
					<form id="formlogin" method="post" >
						...
						<li>
						    ...
						    <div style="text-align:center ; margin-bottom:20px;line-height:30px">
								<span >&nbsp&nbsp&nbsp&nbsp</span>
								 <img alt="" src="/situ-shopping-web/sysToolAction/generatingVerificationCode.do" id = "authImg" style ="margin-top:0px;vertical-align:middle;"
							         onclick = "this.src='/situ-shopping-web/sysToolAction/generatingVerificationCode.do?'+ Math.random() "
							      />
							      <span >&nbsp&nbsp&nbsp&nbsp</span>
							      <input id = "verificationCodeConfirmId" class=""  style="margin:0px; width:100px;height:20px ; padding-top:0px" placeholder="输入验证码">
							</div>							
						...
						<li class="m-t5" id="btn_sub">
							...
							<a href="javascript:void(0)" id="login_sub" class="login_btn" onclick="login()">登录</a>
						</li>
					<div>
</div></form>
					</ul>
	...
	var login = function (){
		 var verificationCodeValue = $("#verificationCodeConfirmId").val();	
		 $.ajax({		    	
		    	url:"/situ-shopping-web/sysToolAction/confirmVerificationCode.do",
		        type:"post",
		        data:{"verificationCodeValue" : verificationCodeValue },
		        ...
		        success: function(data){
		        	if(data=="no"){
		        	 ...
		        	 var userAccount = document.getElementById("loginname").value;
			 			var userPassword = document.getElementById("password").value;	
			 			$.ajax({		    	
			 		    	url:"/situ-shopping-web/sysUser/login.do",
			 		        type:"post",
