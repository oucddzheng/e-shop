...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/jquery.alerts.css" />
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/headerfooterindex.css" />
    <script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery-1.5.1.min.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery.cookie.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/passport.common.js?v20140531"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery.alerts.js"></script>
 	<script type="text/javascript" src="<%=request.getContextPath()%>/js/png.js?v20140521"></script>
    <script type= "text/javascript" src = <%= request.getContextPath()%>/js/toolFunctions.js></script>
</head>
<body>
		<!-- header -->
		<div class="header">
		<!-- <%=request.getContextPath()%>  -->
			<a href="#"><img src="" border="0" /><span>欢迎注册</span></a>
		</div>		
		<!--mainStart-->
		
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/reg.css?v20140432" />
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/allMail.js?v20140430"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/reg.js?v20150122"></script>

		<!-- reg_main -->
		<div class="tabBox clear">
		    <span class="reg_hide reg_show regMr5" id="regper">个人用户</span>
		    <span class="reg_hide" id="regcom" style="">企业用户</span>    <div class="login">已有账号，立即 <a href="login.jsp">登录</a></div>
		</div>
		<!--个人用户-->
		    ...
		    <ul class="individualUserBg">
		        <form id="regForm_mod" name="regForm_mod" method="post"  >
		            ...
		            <span class="regM defaultBorder">
		            	<input id="regName" name="username"  class="regInput" type="text"  placeholder="" onkeyup="mail_div(event);" onfocus="showtip('regName','userMamErr',8);" onblur="ckmem();" autocomplete="off" maxlength="80"/> 		   
						<em></em>
		            </span>
		                <span class="regInputClass" id="userMamErr"></span>
		            </li>
		            ...
		            <li class="regMb30">
		                <label><font>*</font> 用户姓名：</label>
		            <span class="regM defaultBorder">
		            	<input id="username" name="phone" autocomplete="off" class="regInput" type="text" maxlength="11" onfocus="showtip('phone','phoneErr',1);" onblur="$('#phoneErr').html('')"/>
		            ...
		            <li class="register regPl88 regMt10" id="sub_per" style="margin-left:29px">
		                ...
		                <a href="javascript:void(0);" class="registerNow" id="reg_per_data" onclick="submitRegister()">立即注册</a>  <!-- REGISTER.reg() -->
		            </li>
		            <br /><br />
		        </form>
		    </ul>
...
<script type="text/javascript">
    ...
    function submitRegister(){
    	...
    	var userAccount = document.getElementById("regName").value;
    	var userPassword = document.getElementById("pwd").value;
    	var userName = document.getElementById("username").value;   	
    	$.ajax({		    	
		    	url:"/situ-shopping-web/sysUser/save.do",
		        type:"post",
		        data:{"userAccount" : userAccount , "userPassword" : userPassword , "userName" : userName},
